...
type ProfileLoader func(botID string, chatID int64, userID int64, opts ...any) (any, error)

// ProfileStorer is a storer for user profile
type ProfileStorer func(botID string, chatID int64, userID int64, profile any, opts ...any) error
